...
@TeleOp(name = "TelemetrySafe", group = "MecanumBot")
public class TelemetrySafe extends LinearOpMode {
...
//        DistanceSensor backDistance = hardwareMap.get(DistanceSensor.class, "back_distance");
        ...
        while (opModeIsActive()) {
            ...
            double clicks = (double) (clicks = mlift.getCurrentPosition());
            ...
            if (gamepad2.dpad_up && clicks < 5400) {
