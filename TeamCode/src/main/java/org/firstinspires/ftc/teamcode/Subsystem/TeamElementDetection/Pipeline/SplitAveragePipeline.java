...
public class SplitAveragePipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        //Defining Zones
        //Rect(top left x, top left y, bottom right x, bottom right y); 1 = left 2 = middle
        zone1 = input.submat(new Rect(400, 440, 200, 200));
        zone2 = input.submat(new Rect(975, 430, 180, 180));
